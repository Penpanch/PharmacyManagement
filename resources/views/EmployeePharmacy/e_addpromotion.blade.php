...
@endsection
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <label for="image"><div class="col-md-7"><br><img  id="showimg" alt="" width="860" height="303"><br><br></div>
</label>
    ...
    <div class="form-group">
      ...
      <textarea name="description_pro" class="form-control" id="description_pro" rows="3"></textarea>
    </div>
