  ...
  <!-- <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <form>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center><a href="shopEm/delete/{{$i->id}}"onclick="return confirm('Are you sure to delete')" class="glyphicon glyphicon-trash"></a></center></td>
                            </tr>
                ...
                <a href="{{url('billEm/clear')}}" class="btn btn-primary" >ยกเลิก</a>
                </center>
            </form>
        </div>
    </div>
